export default {
    ...
    photos_collected: '已收藏至「{album}」',
    photos_collection_failed: '收藏失败，请重试',
    photos_create_album_failed: '创建相册失败，请重试',
    ...
    ai_scanner_error: '错误',
    ai_scanner_engine: 'AI 扫描引擎',
    ai_scanner_pending: '待扫描',
    ai_scanner_done: '已完成',
    ai_scanner_scanning_batch: '扫描中…（批次 {batch}）',
    ai_scanner_stop: '停止扫描',
    ai_scanner_start: '开始扫描',
    ai_scanner_resetting: '重置中…',
    ai_scanner_reset: '重置扫描进度',
    scan_batch: '扫描一批',
    ...
    scan_tab_similar: '相似',
    scan_tab_ai: '智能分类',
    scan_delete_blurry_title: '删除模糊照片',
    scan_delete_blurry_message: '确定要删除这张照片吗？',
    delete: '删除',
    delete_failed: '删除失败',
    scan_blur_score: '模糊度：{score}',
    scan_brightness: '亮度：{value}',
    scan_organizing: '正在整理相册…',
    scan_group_count: '{count} 组',
    scan_no_people: '暂无人物照片',
    scan_objects_scenes: '事物 & 场景',
    scan_category_count: '{count} 类',
    scan_no_results: '暂无识别结果',
    scan_uncategorized: '未分类',
    scan_photo_count: '{count} 张',
